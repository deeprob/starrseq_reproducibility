...
#SBATCH -o /data5/deepro/starrseq/papers/reproducibility/3_read_lib_qc/slurm/logs/out_%a.log
#SBATCH -e /data5/deepro/starrseq/papers/reproducibility/3_read_lib_qc/slurm/logs/err_%a.log
#SBATCH --array 1-13
