...
def main(
    ...
    # get peak file
    peak_file = ut.get_peak_file(peak_dir, lib_short)
    # get input bam files
    ...
    # store coverage dfs
    in_cov_filename, out_cov_filename = ut.get_rep_cov_filename(store_dir, lib_short, "input"), ut.get_rep_cov_filename(store_dir, lib_short, "output")
